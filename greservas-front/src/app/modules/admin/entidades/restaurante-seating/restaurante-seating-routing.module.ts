...
const routes: Routes = [{ path: '', component: RestauranteSeatingComponent,
  children: [
      ...
      { path: 'resume', component: RestauranteSeatingComponent },
...
export class RestauranteSeatingRoutingModule { }
