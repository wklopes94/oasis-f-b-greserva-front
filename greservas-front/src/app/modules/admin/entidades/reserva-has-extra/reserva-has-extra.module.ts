...
import { ReservaHasExtrasRoutingModule } from './reserva-has-extra-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    ReservaHasExtrasRoutingModule
  ]
})
export class ReservaHasExtraModule { }
